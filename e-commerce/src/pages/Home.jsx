...
function Home() {
    return (
        <>
            <section style={{ backgroundColor: "#F2F0F1" }} className="bg-gray-50 max-w-7xl mx-auto px-4 py-12 flex flex-col md:flex-row items-center justify-between gap-8 bg-gray">
            ...
            <div className="bg-black font-bold justify-evenly py-6 flex text-3xl ">
                <h1 className="text-white">VERSACE</h1>
                <h1 className="text-white">ZARA</h1>
                <h1 className="text-white">CUCCI</h1>
                <h1 className="text-white">PRADA</h1>
                <h1 className="text-white">CALVIN KLIEN</h1>
            </div>
        </>
    );
}
